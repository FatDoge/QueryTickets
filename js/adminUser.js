            ...
            layui.use('table', function(){
                ...
                table.render({
                  ...
                  ,cols: [[ //表头
                    ...
                    ,{field: 'username', title: '用户名', width:'20%', sort: false,align:'center',edit: 'text'}  
                    ,{field: 'password', title: '密码', width:'20%', sort: false,align:'center',edit: 'text'}
                    ,{field: 'name', title: '昵称', width:'20%',align:'center',edit: 'text'}
