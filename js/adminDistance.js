            ...
            layui.use('table', function(){
                ...
                table.render({
                  ...
                  ,cols: [[ //表头
                    ...
                    ,{field: 'trainStationByStart', title: '出发站', width:'20%', sort: false,align:'center'}  
                    ,{field: 'trainStationByEnd', title: '到达站', width:'20%', sort: false,align:'center'}
                    ,{field: 'distance', title: '站点距离', width:'20%',align:'center',edit: 'num'}
